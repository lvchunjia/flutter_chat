...
///IMessage的的具体实现
class MessageDao implements IMassage, ITable {
  ...
  MessageDao(
    ...
    storage.db.execute(
      'create table if not exists $tableName (id integer primary key autoincrement, content	text, createdAt	integer, ownerName text, ownerType	text, avatar	text)',
    );
  }
  ...
  Future<int> getMessageCount() async {
    var result = await storage.db.query(
      tableName,
