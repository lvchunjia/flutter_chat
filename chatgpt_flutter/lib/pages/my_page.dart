...
import 'package:chatgpt_flutter/widget/theme_widget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_zhonglvshiqi_cache/flutter_zhonglvshiqi_cache.dart';
...
class _MyPageState extends State<MyPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Column(
        children: [
          HeaderWidget(avatar: avatar, name: userName, imoocId: imoocId),
          20.paddingHeight,
          const Divider(),
          ..._itemWidget(
            color: color,
  ...
  void _showUpdateDialog(ApkModel model) async {
    var result = await HiDialog.showDownloadDialog(
      context,
      title: '有新版本啦',
  ...
  void _setProxy() async {
    ...
    var result = await HiDialog.showProxySettingDialog(
      context,
