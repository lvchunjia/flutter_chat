...
class AIConfigBuilder {
  ...
  String? _apiKey;
  // 注意：1、使用电脑的IP地址，不要用127.0.0.1（在Android上会被识别成Android设备的本地机）;2、如果使用 clashx 需要开启Allow connect from Lan，否则会：Connection refused
  String? _proxy;
  // 发者后台设置的组织ID，可不传
  String? _organization;
  //于会话的接口地址，从 https://platform.openai.com/docs/api-reference/chat  上获取
